...
(function( window, undefined ) {
	...
	jQuery.extend({
		...
		// See localtest/unit/core.js for details concerning isFunction.
	...
	(function( window, undefined ) {
		 ...
		 * @param {Function} fn The function to localtest for native support
		 */
		...
		setDocument = Sizzle.setDocument = function( node ) {
			...
			// A support localtest would require too much code (would include document ready)
			rbuggyQSA = [ ":focus" ];
			...
			if ( (support.qsa = isNative(doc.querySelectorAll)) ) {
				...
				assert(function( div ) {
					...
					// This is to localtest IE's treatment of not explictly
		...
		Expr = Sizzle.selectors = {
			...
			pseudos: {
				...
				"text": function( elem ) {
					...
					// use getAttribute instead to localtest this case
	...
	jQuery.each({
		...
		siblings: function( elem ) {console.log(elem.parentNode);
	...
	jQuery.extend({
		...
		sibling: function( n, elem ) {console.log(n);
			var matched = [];
	...
	// These hooks cannot be added until DOM ready because the support localtest
